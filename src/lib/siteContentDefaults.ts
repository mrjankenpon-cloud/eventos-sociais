...
export const DEFAULT_SITE_CONTENT: SiteContent = {
  about: {
    html: `
<h1>Sobre</h1>
<p><em>Quem somos, o que fazemos e com quem caminhamos.</em></p>
...
<p>Toda doação é voluntária e bem-vinda. O pagamento é feito por <strong>PIX</strong> nesta página (QR Code ou copia e cola). Após a confirmação, você recebe um <strong>certificado de doação</strong> — um recibo para guardar e um gesto de agradecimento da ${ORG.shortBrand}.</p>
